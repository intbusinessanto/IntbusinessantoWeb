...
class Skin_1 extends Skin_Base {
	...
	public function register_product_title_style( Widget_Base $widget ) {
	...
	public function register_product_category_style( Widget_Base $widget ) {
	 ...
	 * @access public
	 */
	public function register_sale_products_controls( Widget_Base $widget ) {
	 ...
	 * @access public
	 */
	public function register_sale_style_controls( Widget_Base $widget ) {
	 ...
	 * @access public
	 */
	public function register_featured_products_controls( Widget_Base $widget ) {
	 ...
	 * @access public
	 */
	public function register_featured_style_controls( Widget_Base $widget ) {
